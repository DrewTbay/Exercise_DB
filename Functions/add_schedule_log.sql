...
-- Function: add_schedule_log(text, text, text, integer, integer);

DROP FUNCTION IF EXISTS add_schedule_log(text, text, text, integer, integer);

CREATE OR REPLACE FUNCTION add_schedule_log(
    _schedule_name text,
    _workout_name text,
    _user_name text,
    _day_done integer,
...
GRANT EXECUTE ON add_schedule_log TO exercise_conn;
